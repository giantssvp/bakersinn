<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_biscuits.aspx.cs" Inherits="product_biscuits" %>
		...
		<div>
			<ul>
				...
				<li>
					<div>
						<div>
							<h2>Shrewsbury Biscuits</h2>
							<br>
							<p><b>It is a classic English dessert named after Shrewsbury,the county town of Shropshire.</b> </p>
						</div>
						<img src="images/product/biscuits/shrewsbury.jpg" alt="Image"  />
					</div>
				</li>
				...
				<li>
					<div>
						<div>
							<h2>Coconut Cookies</h2>
							
							<br><p><b> All coconut lovers, you can now munch on some tasty coconut cookies.</b></p>
						</div>
						<img src="images/product/biscuits/coconut.jpg" alt="Image"  hspace="10" />
					</div>
				</li>
				<li>
					<div>
						...
						<img src="images/product/biscuits/mava.jpg" alt="Image"  border="1" vspace="10" />
					</div>
				</li>
				<li>
					<div>
						...
						<img src="images/product/biscuits/chocolate.jpg" alt="Image"  border="1" hspace="10" vspace="10"/>
					</div>
				</li>
                <li>
					<div>
						...
						<img src="images/product/biscuits/fruitnut.jpg" alt="Image"  border="1" vspace="1" />
					</div>
				</li>
				<li>
					<div>
						...
						<img src="images/product/biscuits/bournvita.jpg" alt="Image"  hspace="10" vspace="1"/>
					</div>
				</li>
				<li>
					<div>
						...
						<img src="images/product/biscuits/chocochips.jpg" alt="Image"  border="1" hspace="1" vspace="10"/>
					</div>
				</li>
				<li>
					<div>
						...
						<img src="images/product/biscuits/almond.jpg" alt="Image"  border="1"  vspace="10" hspace="10" />
					</div>
				</li>
				<li>
					...
					<div>
						...
						<img src="images/product/biscuits/cashew.jpg" alt="Image"  border="1" vspace="1"/>
					</div>
				</li>
				...
				<li>
					<div>
						...
						<img src="images/product/biscuits/coffee.jpg" alt="Image"  border="1" hspace="10" vspace="1"/>
					</div>
				</li>
				...
				<li>
					<div>
						...
						<img src="images/product/biscuits/butterscotch.jpg" alt="Image"  border="1" hspace="1" vspace="10"/>
					</div>
				</li>
				...
				<li>
					<div>
						...
						<img src="images/product/biscuits/kesarnankatai.jpg" alt="Image" hspace="10"  vspace="10"/>
					</div>
				</li>
				<li>
					<div>
						...
						<img src="images/product/biscuits/cornflakes.jpg" alt="Image" vspace="1"/>
					</div>
				</li>
				...
				<li>
					<div>
						...
						<img src="images/product/biscuits/ginger.jpg" alt="Image" hspace="10" vspace="1"/>
					</div>
				</li>
				...
				<li>
					<div>
						...
						<img src="images/product/biscuits/honeyalmond.jpg" alt="Image"  border="1" vspace="10"  />
					</div>
				</li>
				...
				<li>
					<div>
						...
						<img src="images/product/biscuits/cashewcoconut.jpg" alt="Image" hspace="10" vspace="10"/>
				       </div>
				</li>
